                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="categoryName" class="form-control @error('categoryName') is-invalid @enderror" placeholder="Category Name" value="{{$categories->categoryName}}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="projectLink" class="form-control @error('projectLink') is-invalid @enderror" placeholder="Project Link" value="{{$categories->projectLink}}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="iconImage" class="form-control @error('iconImage') is-invalid @enderror" placeholder="Icon Image" value="{{$categories->iconImage}}">
